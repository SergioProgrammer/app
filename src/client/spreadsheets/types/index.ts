...
export const SPREADSHEET_COLUMNS = [
  ...
  { key: 'finalClient', label: 'Cliente final', width: 220, inputType: 'text' as ColumnInputType },
  { key: 'kg', label: 'Kg por bulto', width: 140, inputType: 'number' as ColumnInputType },
  { key: 'product', label: 'Producto', width: 260, inputType: 'text' as ColumnInputType },
  ...
  { key: 'abono', label: 'Abono', width: 120, inputType: 'number' as ColumnInputType },
  { key: 'price', label: 'Precio', width: 120, inputType: 'number' as ColumnInputType },
  { key: 'awb', label: 'AWB', width: 180, inputType: 'text' as ColumnInputType },
  ...
  { key: 'incoterm', label: 'Incoterm', width: 140, inputType: 'text' as ColumnInputType },
  { key: 'deliveryNote', label: 'Albarán', width: 170, inputType: 'text' as ColumnInputType },
